...
function f11() {
    let a = document.querySelector('.i-11');
    let b = +a.value;
    if (a.value !== '') {
    document.querySelector('.out-11').innerHTML = d11.indexOf(b);
    a.value = '';
    }
}
...
function f18() {
let b = d18.includes(document.querySelector('.i-18').value);
document.querySelector('.i-18').value = "";
document.querySelector('.out-18').innerHTML = b
}
