...
document.querySelector('.out-1').innerHTML = k;
}
...
function t2() {
    ...
    document.querySelector('.out-2').innerHTML = k;
}
...
function t3() {
    ...
    document.querySelector('.out-3').innerHTML = k;
}
...
document.querySelector('.out-5').innerHTML = k;
}
...
function t8() {
    let out = +document.querySelector('.i-81').value;
    let out1 = +document.querySelector('.i-82').value;
    let a = '';
    let i = out;
    while(i <= out1 ){
        a += i + '_';
...
function t11() {
    let a = document.getElementsByClassName('div-11');
    let out = '';
    let i = 0;
     while(i < a.length){
        out += a[i].innerHTML + '_';
...
function t12() {
    let a = document.getElementsByClassName('div-12');
    let out = '';
    let i = 0;
     while(i < a.length){
...
function t13() {
    let a = document.getElementsByClassName('i-13');
    let i = 0;
    while(i < a.length){
        i++
        a[0].value = 1;
...
function t14() {
    let a = document.getElementsByClassName('i-14');
