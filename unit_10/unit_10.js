...
let ar1 = ['Test', 'Test1', 2, 4, true, false]
...
let ar2 = ['Test', 'Test1', 2, 4, true, false]
...
// Тест допустим массив [1,2,3] вывод - 3
 ...
 let ar3 = ['Test', 'Test1', 2, 4, 5, true, false] 
...
let ar4 = ['Test', 'Test1', 'JS', 2, 4, 5, 9, true, false] 

function f4() {
     let a = [ar4[0], ar4[3], ar4[8]];
...
function f10() {
    document.querySelector('.out-10').textContent = ar10[ar10.length - 1] + ar10[1];
}
...
for(i = 0; i < ar13.length; i++){
    ...
    document.querySelector('.out-13').innerHTML = b;
}
...
function f14() {
    let b ='';
    for(i = 0; i < ar14.length; i++){
        b += ar14[i] + ' ';
    }
        document.querySelector('.out-14').innerHTML = b;
    }
