...
function t1(event) {
    console.log(event);
    let key = event.key;
    document.querySelector('.out-1').innerHTML = key;
}
...
function t2(event) {
    ...
    document.querySelector('.out-2').innerHTML = key;
}
...
function t4(event) {
    ...
    document.querySelector('.out-4').innerHTML = u4;
...
function t5(event) {
    console.log(event);
    u5 += event.key.toUpperCase();
    document.querySelector('.out-5').innerHTML = u5;
}
...
function t6(event) {
    if(event.key == event.key.toLowerCase())
    u6 += event.key;
    document.querySelector('.i-6').value = u6;
...
function t7() {
    let u7 = a7[Math.floor(Math.random() * a7.length)];
    document.querySelector('.out-7').innerHTML = u7;
}
...
function t8(event) {
    ...
    document.querySelector('.out-8').innerHTML = u8;
}
...
function t9(event) {
    ...
    document.querySelector('.out-9').innerHTML = u9;
}
...
function t11(event) {
    ...
    for(let item of divs){
        ...
        if( item.innerHTML == event.key  || item.innerHTML == obj[event.key]) {
