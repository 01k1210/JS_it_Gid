...
//   сложение числа и строки = конкатенация
...
let e2 = 3
let f2 = 0
document.querySelector('.out-5').textContent = 3/0;
...
let div2 = document.querySelector('.out-10');
document.querySelector('.b-10').onclick = function(){
    let data = document.querySelector('.i-10').value; 
    div2.innerHTML = data * 20;
}
...
let div4 = document.querySelector('.out-12')
document.querySelector('.b-12').onclick = function(){
    let name = document.querySelector('.i-12-1').value;
    let postname = document.querySelector('.i-12-2').value;
    
    div4.innerHTML = "Hello" + ' ' + name + postname  ;
}
...
let div5 = document.querySelector('.out-13')
...
function t14() {
 let c = document.querySelector('.i-14');
 c.value = 'Go'
}
...
let div6 = document.querySelector('.out-16')
function t16() {
    let g = document.querySelector('.i-16-1').value;
    let n = document.querySelector('.i-16-2').value;
    div6.innerHTML = Number(g) + Number(n);
}
...
function t19() {
let s = document.querySelector('.i-19-1').value;
let z = document.querySelector('.i-19-2').value;
document.querySelector('.out-19').innerHTML = Number(s) + Number(z);
}
