...
function t2() {
 u2++;
 document.querySelector('.out-2').innerHTML = u2;
}
...
function t3() {
 document.querySelector('.out-3').innerHTML = 'div-3_1';
}
function t3_1() {
 document.querySelector('.out-3').innerHTML = 'div-3_2';
}
...
function t8() {
 let colors = a8[Math.floor(Math.random() * a8.length)]
 document.querySelector('.div-8').style.backgroundColor = colors;
}
...
function t11(event) {
 ...
 document.querySelector('.out-11').innerHTML = event.changedTouches[0].radiusY + ' ' + event.changedTouches[0].radiusX;
