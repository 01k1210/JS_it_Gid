...
function f5() {
    ...
    if(a.checked){
        document.querySelector(".out-5").innerHTML = a.value; 
    }
    else{
...
function f7() {
    ...
    document.querySelector('.out-71').innerHTML = a;
    if(a.length >= 6){
...
function f9() {
    ...
    if(a.checked){
        document.querySelector('.out-9').innerHTML = 'value radiobutton';    
    }
    else{
...
function f10() {
    ...
    document.querySelector('.out-10').style.background = a;
}
...
function f12() {
    let a = document.querySelector('.i-12');
    document.querySelector('.out-12').innerHTML = a.value;
}
...
function f13() {
    let a = document.querySelector('.i-13');
    document.querySelector('.out-13').innerHTML = a.value;
}
...
function f15() {
    ...
    document.querySelector('.t-15').innerHTML = a;
...
function f19() {
    let a = document.querySelector('.out-19').innerHTML;
    document.querySelector('.i-19').value = a;
