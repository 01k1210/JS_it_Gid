...
function f5() {
if(document.querySelector('.out-4').classList.toggle('bg-orange')){
...
function f6() {
let a = document.getElementsByClassName('p-6');
let out = "";
...
function f19() {
    let a = document.getElementsByClassName('p-19');
    let out = '';
    for(i = 0; i < a.length; i++){
        out += a[i].getAttribute('data-b') + ' '
    }
