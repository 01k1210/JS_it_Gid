...
function t1() {
 ...
 .then((data) => document.querySelector('.out-1').textContent = data)
}
...
function t2() {
 fetch('http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=2&name=Kirill')
 .then((response) => response.text())
...
function t3() {
 fetch('http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=3&num1=10&num2=30')
 .then((response) => response.text())
...
function t4() {
 fetch('http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=4&num1=10&num2=30')
 .then((response) => response.text())
...
function t6() {
 fetch('http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=6&num1=10&num2=30')
 .then((response) => response.text())
...
function t7() {
 ...
 .then((response) => response.text())
 .then((data) => document.querySelector('.out-7').textContent = data)
}
...
function t8() {
 ...
 .then((response) => response.text())
 .then((data) => document.querySelector('.out-8').textContent = data)
}
...
function t9() {
 ...
 .then((response) => response.text())
 .then((data) => document.querySelector('.out-9').textContent = data)
}
...
.then((response) => response.text())
.then((data) => document.querySelector('.out-10').textContent = data)
}
...
function t11() {
 fetch('http://getpost.itgid.info/index2.php', {
  method: 'POST', 
  body: 'auth=7859d9d42a8834141d529577207c9596&action=2&name=Kirill',
  headers: {
    'Content-type': 'application/x-www-form-urlencoded',
  },
})
.then((response) => response.text())
.then((data) => document.querySelector('.out-11').textContent = data)
}
...
function t12() {
 fetch('http://getpost.itgid.info/index2.php', {
  method: 'POST', 
  body: 'auth=7859d9d42a8834141d529577207c9596&action=3&num1=10&num2=30',
  headers: {
    'Content-type': 'application/x-www-form-urlencoded',
  },
})
.then((response) => response.text())
.then((data) => document.querySelector('.out-12').textContent = data)
}
...
function t13() {
 fetch('http://getpost.itgid.info/index2.php', {
  method: 'POST', 
  body: 'auth=7859d9d42a8834141d529577207c9596&action=4&num1=10&num2=30',
  headers: {
    'Content-type': 'application/x-www-form-urlencoded',
  },
})
.then((response) => response.text())
.then((data) => document.querySelector('.out-13').textContent = data)
}
...
.then((response) => response.text())
.then((data) => document.querySelector('.out-14').textContent = data)
}
...
function t15() {
 fetch('http://getpost.itgid.info/index2.php', {
  method: 'POST', 
  body: 'auth=7859d9d42a8834141d529577207c9596&action=6&num1=10&num2=30',
  headers: {
    'Content-type': 'application/x-www-form-urlencoded',
  },
})
.then((response) => response.text())
.then((data) => document.querySelector('.out-15').textContent = data)
}
...
.then((response) => response.text())
.then((data) => document.querySelector('.out-16').textContent = data)
}
...
function t17() {
 fetch('http://getpost.itgid.info/index2.php', {
  method: 'POST', 
  body: 'auth=7859d9d42a8834141d529577207c9596&action=8&year=1996',
  headers: {
    'Content-type': 'application/x-www-form-urlencoded',
  },
})
.then((response) => response.text())
.then((data) => document.querySelector('.out-17').textContent = data)
}
...
.then((response) => response.text())
.then((data) => document.querySelector('.out-18').textContent = data)
}
